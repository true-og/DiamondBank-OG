package io.github.andromdaa.util;
...
public class Util {
    ...
    public static void diamondBankMessage(Player p, String message) {

        p.sendMessage(legacySerializerAnyCase(Plugin.getPlugin().getConfig().getString("config.prefix") + message));
