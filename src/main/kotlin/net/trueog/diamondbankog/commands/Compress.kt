    ...
    override fun onCommand(
        ...
        DiamondBankOG.scope.launch {
            ...
            if (changeInShards == 0 && changeInDiamonds == 0 && changeInDiamondBlocks == 0) {
                sender.sendMessage(DiamondBankOG.mm.deserialize("${Config.prefix}<reset>: <#FFA500>Nothing found to compress."))
                return@launch
            }
            ...
            val diamondsLine =
                (if (changeInDiamonds > 0) "|<green>+$changeInDiamonds" else if (changeInDiamonds < 0) "|<red>$changeInDiamonds" else "") + if (changeInDiamonds > 0 || changeInDiamonds < 0) " Diamond${
                    if (abs(
                            changeInDiamonds
                        ) != 1
                    ) "s" else ""
            ...
            val diamondBlocksLine =
                (if (changeInDiamondBlocks > 0) "|<green>+$changeInDiamondBlocks" else if (changeInDiamondBlocks < 0) "|<red>$changeInDiamondBlocks" else "") + if (changeInDiamondBlocks > 0 || changeInDiamondBlocks < 0) " Diamond Block${
                    if (abs(
            ...
            sender.sendMessage(
                DiamondBankOG.mm.deserialize(buildString {
